...
class ProductTest {
    ...
    @Nested // 테스트 결과 트리형식으로 만들어 주는 어노테이션
    ...
    class CreateUserProduct {
        ...
        @BeforeEach // 테스트 시행전 모든 테스트에 추가해주는 부분
        void setup() {
...
// then
                    assertEquals("상품 최저가 페이지 URL 포맷이 맞지 않습니다.", exception.getMessage()); // 문자열로 하는 방법은 지양함 다양한 exception 만드는 것이 좋다.
                }
